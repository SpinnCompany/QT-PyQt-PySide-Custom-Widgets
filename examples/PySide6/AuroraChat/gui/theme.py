"""Theme helpers — read the token-driven chat surface palette + icon colours
...
ICON_COLOR = {THEME_LIGHT: "#98a1b3", THEME_DARK: "#aeb6c8"}
...
def chat_palette(theme_name):
    """Return the ChatPalette dict for the active theme (falls back to light)."""
    pal = _load().get("ChatPalette", {})
