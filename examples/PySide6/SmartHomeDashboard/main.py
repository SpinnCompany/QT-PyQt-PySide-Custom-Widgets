########################################################################
## WINNING — Analytics dashboard, built the CORRECT Custom_Widgets way.
##
## The maintainable pipeline (not a pure-code app):
##   ui/*.ui  ->  compiled src/ui_*.py       (Custom_Widgets --convert-ui)
##   json-styles/style.json                  (Winning Dark / Light CustomThemes)
##   Qss/scss/*.scss  ($TOKENS, no hard-coded hex)
##   gui/GuiFunctions.py                      (orchestrator + per-page managers + workers)
##
...
class MainWindow(QCustomMainWindow):
    ...
    def build(self):
        ...
        # Apply the Winning Dark / Light themes from the JSON stylesheet.
