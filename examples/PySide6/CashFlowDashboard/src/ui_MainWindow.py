...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Cash Flow \u2014 Dashboard", None))
        ...
        self.sidebarAvatar.setProperty(u"text", QCoreApplication.translate("MainWindow", u"L", None))
        self.avatarName.setText(QCoreApplication.translate("MainWindow", u"  Lisa Nguyen", None))
