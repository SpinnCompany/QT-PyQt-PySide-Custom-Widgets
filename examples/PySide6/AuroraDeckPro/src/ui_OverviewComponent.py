...
class Ui_OverviewComponent(object):
    def setupUi(self, OverviewComponent):
        ...
        self.statLive.setGeometry(QRect(0, 0, 300, 150))
        self.statLive.setMinimumSize(QSize(300, 150))
        self.statLive.setMaximumSize(QSize(300, 150))
        self.statKp = QCustomStatCard(self.statsFlow)
        self.statKp.setObjectName(u"statKp")
        self.statKp.setGeometry(QRect(316, 0, 300, 150))
        self.statKp.setMinimumSize(QSize(300, 150))
        self.statKp.setMaximumSize(QSize(300, 150))
        self.statOdds = QCustomStatCard(self.statsFlow)
        self.statOdds.setObjectName(u"statOdds")
        self.statOdds.setGeometry(QRect(632, 0, 300, 150))
        self.statOdds.setMinimumSize(QSize(300, 150))
        self.statOdds.setMaximumSize(QSize(300, 150))
        self.statClear = QCustomStatCard(self.statsFlow)
        self.statClear.setObjectName(u"statClear")
        self.statClear.setGeometry(QRect(948, 0, 300, 150))
        self.statClear.setMinimumSize(QSize(300, 150))
        self.statClear.setMaximumSize(QSize(300, 150))
