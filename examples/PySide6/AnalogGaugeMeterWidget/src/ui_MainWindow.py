...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gauge = AnalogGaugeWidget(self.widget_5)
        ...
        self.gauge.setMinimumSize(QSize(300, 300))
        self.gauge.setMaximumSize(QSize(600, 600))
        self.gauge.setBaseSize(QSize(300, 300))
        self.horizontalLayout = QHBoxLayout(self.gauge)
        self.horizontalLayout.setObjectName(u"horizontalLayout")

        self.verticalLayout.addWidget(self.gauge)
        ...
        self.frame_2 = QFrame(self.rightPanel)
        ...
        self.widget_15 = QWidget(self.rightPanel)
        ...
        self.lcdScalaCount.setProperty(u"intValue", 10)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"AnalogGaugeWidget Showcase", None))
