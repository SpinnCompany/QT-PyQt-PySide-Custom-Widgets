...
class QCustomLineChart(QCustomChartBase, AxisChartProps, SeriesStyleProps,
    ...
    # carry: <header>Custom_Widgets.QCustomCharts.QCustomLineChart</header>
    WIDGET_MODULE = "Custom_Widgets.QCustomCharts.QCustomLineChart"
    ...
    # and SeriesStyleProps (see QCustomChartProps.py). Only line-chart
