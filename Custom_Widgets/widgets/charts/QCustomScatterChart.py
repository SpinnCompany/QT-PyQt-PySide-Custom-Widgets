...
########################################################################
"""QCustomScatterChart — a Custom Widgets **Pro** widget.
...
path `Custom_Widgets.QCustomScatterChart` is baked into every Qt Designer .ui file that uses
...
says what to do.
"""
_PRO_MODULE = "custom_widgets_pro.widgets.charts.QCustomScatterChart"

_MESSAGE = (
    "QCustomScatterChart is part of Custom Widgets Pro and is not included in the free "
    "GPLv3 package.\n"
