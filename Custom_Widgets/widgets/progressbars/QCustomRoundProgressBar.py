...
class QCustomRoundProgressBar(QWidget):
    ...
    # legacy QCustomProgressBars aggregate it used to name. stubgen keys off
    # this: it imports WIDGET_MODULE and introspects the classes defined there,
    # so pointing at an aggregate that merely re-exports meant no stub was ever
    # generated for this widget.
    #
    # Existing .ui files are unaffected. Four of them carry
    # Custom_Widgets.QCustomProgressBars in <header>; that module still exists,
    # still re-exports this class, and resolves to the identical object.
    # WIDGET_MODULE only decides what Designer writes into NEW .ui files.
    WIDGET_MODULE = "Custom_Widgets.QCustomRoundProgressBar"
