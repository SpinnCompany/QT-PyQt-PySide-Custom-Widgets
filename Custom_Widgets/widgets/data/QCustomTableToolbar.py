...
########################################################################
"""QCustomTableToolbar — a Custom Widgets **Pro** widget.
...
path `Custom_Widgets.QCustomTableToolbar` is baked into every Qt Designer .ui file that uses
...
says what to do.
"""
_PRO_MODULE = "custom_widgets_pro.widgets.data.QCustomTableToolbar"
