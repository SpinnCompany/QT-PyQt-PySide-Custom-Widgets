...
class QCustomBarChartBase(QCustomChartBase):
    ...
    # Shared by QCustomVerticalBarSeries and QCustomHorizontalBarSeries.
    # Orientation-dependent properties (showGrid, customGridColor) are
    # declared in those subclasses.
